        ...
        <div className="flex-1 overflow-y-auto px-2 space-y-3 py-1">
          ...
          <div className="space-y-0.5">
            <div className="flex items-center justify-between px-2 py-1">
              <span className="text-[10px] uppercase tracking-wider font-semibold text-[#8a8579]">Projects</span>
              <button
                onClick={onOpenNewProject}
                className="p-0.5 rounded hover:bg-[#2a2822] text-[#8a8579] hover:text-[#cc785c] transition-colors"
                title="New Project"
              >
            ...
            {projects.length === 0 ? (
              <button
                onClick={onOpenNewProject}
                className="w-full text-left px-2.5 py-1.5 rounded-lg text-[11px] text-[#6b675d] hover:text-[#ece9e2] hover:bg-[#23221c] transition-colors flex items-center space-x-2"
              >
              ...
              projects.map((proj) => (
                <div
                  key={proj.id}
                  className="group flex items-center rounded-lg px-2.5 py-2 text-xs font-medium cursor-pointer text-[#bfb9ad] hover:bg-[#23221c] hover:text-[#ece9e2] transition-all"
                >
                  <FolderKanban className="w-3.5 h-3.5 mr-2 shrink-0 text-[#cc785c] opacity-70" />
